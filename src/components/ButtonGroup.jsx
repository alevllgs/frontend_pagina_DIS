...
const ButtonGroup = () => {
  return (
    <div className="buttons">
      ...
      <Button href="mapa_derivacion/" icon="fa-person-walking-arrow-right" title="Mapa de derivación" delay="600" iconColor={palette[2]} /> 
      ...
      <Button href="poblacion/" icon="fa-people-group" title="Poblacion" delay="400" iconColor={palette[4]} />
    </div>
  );
};
