...
const ButtonGroup = () => {
  return (
    <div className="buttons">
      ...
      <Button href="https://app.powerbi.com/view?r=eyJrIjoiNWZkNjNhMDAtNjFjYi00OTgzLTllODctMjc3ZmJhNjUwNTU1IiwidCI6IjA2MDc0N2E5LTk5YjYtNDg4NS1hNmQxLWI3ZDg1OGE4M2E1MyJ9" icon="fa-chart-line" title="Acuerdo de Gestión FONASA" delay="900" iconColor={palette[4]} /> 
      
      <Button href="produccion_hospitalaria/" icon="fa-hospital" title="Producción Hospitalaria" delay="800" iconColor={palette[4]} /> 
      <Button href="actividades_aps/" icon="fa-house-medical" title="Actividades de APS" delay="800" iconColor={palette[0]} /> 
      <Button href="urgencia/" icon="fa-ambulance" title="Atenciones de Urgencia" delay="800" iconColor={palette[4]} /> 
