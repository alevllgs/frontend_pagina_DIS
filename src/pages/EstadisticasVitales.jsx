  ...
  return (
    <div className="layout-container">
      ...
      <div className="ges-page">
        <h1>Estadísticas Vitales</h1>
        <div className="buttons_int">
        <Button
            href="https://app.powerbi.com/view?r=eyJrIjoiYTVlNGE3ODQtYzUwMS00YjgxLWFjNzctZTEwOWE4MTA1NDUzIiwidCI6IjA2MDc0N2E5LTk5YjYtNDg4NS1hNmQxLWI3ZDg1OGE4M2E1MyJ9"
            icon="fa-baby"
          ...
          />
        <Button
            href="https://app.powerbi.com/view?r=eyJrIjoiZWUxYjg1MTQtNzhiOC00ZGY0LWJmMzYtYTdjNDM4ZmQ2MDk3IiwidCI6IjA2MDc0N2E5LTk5YjYtNDg4NS1hNmQxLWI3ZDg1OGE4M2E1MyJ9"
            icon="fa-ribbon"
...
export default EstadisticasVitales;